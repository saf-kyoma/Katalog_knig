...
def combine_backend_files(output_file):
    """
...
if __name__ == "__main__":
    # Выходной файл
    output_file = 'backfront_code.txt'

    # Выполнение функции сбора файлов
    combine_backend_files(output_file)

    # Вывод результата и ожидание завершения
    print(f"Backend files combined and saved to: {output_file}")
